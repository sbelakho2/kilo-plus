...
pub use task::{
    ...
    MAX_VERIFICATION_EVIDENCE_BYTES, MAX_VERIFICATION_PATH_BYTES, MAX_VERIFICATION_PROGRAM_BYTES,
    MAX_VERIFICATION_RECORD_CHECKS, MAX_VERIFICATION_RECORD_CRITERIA,
